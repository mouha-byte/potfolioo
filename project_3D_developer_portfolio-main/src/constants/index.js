...
const education = [
  {
    ...
    icon: "./tech/javascript.png", // Using existing icon as placeholder
    iconBg: "#383E56",
    date: "2018 - 2022",
    points: [
      "Studied computer science fundamentals including algorithms and data structures",
  ...
  },
  {
    ...
    school_name: "Coding Bootcamp",
    icon: "./tech/reactjs.png", // Using existing icon as placeholder
    iconBg: "#E6DEDD",
    date: "2022 - 2023",
    points: [
      ...
      "Completed capstone project with real-world application",
    ],
  },
];
